package edu.universidad.ui; // UI Cursos
...
/** CRUD de cursos independiente del alta de profesores.
 *  Permite crear/actualizar un curso sin profesor y posteriormente asignarlo.
 */
public class CursoController {

    // ---- Formulario ----
    @FXML private TextField txtId;         // ID curso
    @FXML private TextField txtNombre;     // nombre
    @FXML private TextField txtSemestre;   // semestre (1..12)
    @FXML private CheckBox chkActivo;      // activo
    @FXML private TextField txtProfesorId; // profesor a asignar (opcional, para el botón Asignar)
